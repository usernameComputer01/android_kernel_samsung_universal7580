...
/*
extern int hidg_bind_config(struct usb_configuration *c,
			    struct hidg_func_descriptor *fdesc, int index);

extern int ghid_setup(struct usb_gadget *g, int count);
extern void ghid_cleanup(void);
*/
